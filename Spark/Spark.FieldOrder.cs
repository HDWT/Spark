...
public static partial class Spark
{
	private static class FieldOrder
	{
		...
		static FieldOrder()
		{
			s_ordersByType.Add(typeof(long),	IsMono ? 1 : 0);
			s_ordersByType.Add(typeof(double),	IsMono ? 1 : 0);
			s_ordersByType.Add(typeof(ulong),	IsMono ? 1 : 0);

			// Then reference: IsMono ? 0 : 1
