...
public static partial class Spark
{
	...
	{
		int GetObjectSize(object instance, QueueWithIndexer<int> sizes, QueueWithIndexer<object> values, Context context);
		int GetSize(T instance, QueueWithIndexer<int> sizes, QueueWithIndexer<object> values, Context context);
	}

	private interface IDataWriter<T>
	{
		void WriteObject(object instance, byte[] data, ref int startIndex, QueueWithIndexer<int> sizes, QueueWithIndexer<object> values, Context context);
		void Write(T instance, byte[] data, ref int startIndex, QueueWithIndexer<int> sizes, QueueWithIndexer<object> values, Context context);
	}
